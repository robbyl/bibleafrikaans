package tz.co.wadau.biblekingjamesversion.utils;
...
import static tz.co.wadau.biblekingjamesversion.NotesActivity.PREFS_IS_MULTI_COLUMN_VEW;
...
public class Utils {
    ...
    public static void startShareActivity(Context context) {
        String shareText = "Download 'Bible King James Version' at  " +
                "https://play.google.com/store/apps/details?id=tz.co.wadau.biblekingjamesversion";
