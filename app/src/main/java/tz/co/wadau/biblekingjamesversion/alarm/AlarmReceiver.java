...
import tz.co.wadau.biblekingjamesversion.TodayVerseActivity;
...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public static final String DAILY_VERSE_NO = "tz.co.wadau.biblekingjamesversion.DAILY_VERSE_NO";
    public static final String DAILY_VERSE_TEXT = "tz.co.wadau.biblekingjamesversion.DAILY_VERSE_TEXT";

    @Override
    public void onReceive(Context context, Intent intent) {

        if (intent.getAction().equals("tz.co.wadau.biblekingjamesversion.DISPLAY_NOTIFICATION")) {
