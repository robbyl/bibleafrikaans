...
import tz.co.wadau.bibleafrikaans.data.DbContract.BookmarkEntry;
import tz.co.wadau.bibleafrikaans.data.DbContract.VerseHighlightEntry;
import tz.co.wadau.bibleafrikaans.data.DbFileContract.BookEntry;
import tz.co.wadau.bibleafrikaans.data.DbFileContract.ChapterEntry;
import tz.co.wadau.bibleafrikaans.data.DbFileContract.VerseEntry;
import tz.co.wadau.bibleafrikaans.data.DbFileContract.SpecialVerseEntry;
import tz.co.wadau.bibleafrikaans.model.Book;
import tz.co.wadau.bibleafrikaans.model.Chapter;
import tz.co.wadau.bibleafrikaans.model.SpecialVerse;
